...
def build_skeleton_prompt(
    tok, lang: str, question: str, skeleton_lang: str = "en"
) -> str:
    ...
    skeleton_answers = SKELETON_ANSWER_FEWSHOTS.get(
        skeleton_lang, SKELETON_ANSWER_FEWSHOTS["en"]
    )
    ...
    with open(args.output, "w", encoding="utf-8") as f_out:
        for target in load_targets:
            ...
            try:
                ...
                print(
                    f"🚀 Processing {len(task_queue)} tasks (Skeleton Lang: {args.skeleton_lang})..."
                )
                ...
                for batch in tqdm(
                    ...
                    sk_prompts = [
                        build_skeleton_prompt(tok, t["lang"], q, args.skeleton_lang)
...
def main():
    ...
    if args.method == "skeleton_multiturn":
        run_skeleton_multiturn(
            args, llm, tok, config, gen_sp, sk_sp, load_targets, langs
        )
